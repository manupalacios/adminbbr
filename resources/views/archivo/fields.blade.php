<div class="form-group" >
    ...
    <input class="form-control {{ $errors->has('anio') ? ' is-invalid' : '' }}" type="text" name="anio" id="anio" maxlength="4" value="{{ (!empty(old('anio'))) ? old('anio') : '' }}" required>
    @if ($errors->has('anio'))
...
<div class="form-group" >
    ...
    <select class="form-control {{ $errors->has('mes') ? ' is-invalid' : '' }}" name="mes" id="mes" required>
...
<div class="form-group" >
    ...
    <input class="form-control {{ $errors->has('numero') ? ' is-invalid' : '' }}" type="text" name="numero" id="numero" value="{{ (!empty(old('numero'))) ? old('numero') : '' }}">
